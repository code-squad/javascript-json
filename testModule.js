...
let comparisonMethod = (expected, actual) => (actual === actual.clone) === expected ;
...
let comparisonMethod = (expected, actual) => actual === expected ;
...
console.log(`\n`);
let comparisonMethod = (expected, actual) => actual[1] instanceof expected;
